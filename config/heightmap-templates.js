...
const heightmapTemplates = (function () {
  ...
  return {
    ...
    pangea: {id: 8, name: "盘古大陆 Pangea", template: pangea, probability: 5},
    isthmus: {id: 9, name: "地峡Isthmus", template: isthmus, probability: 2},
    shattered: {id: 10, name: "破碎群岛 Shattered", template: shattered, probability: 7},
    ...
    fractious: {id: 13, name: "分裂大陆 Fractious", template: fractious, probability: 3}
  };
})();
